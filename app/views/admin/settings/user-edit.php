    ...
    <div class="col">
        ...
        <form action="" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" class="form-control <?= (!empty($data['password_err'])) ? 'is-invalid' : ''; ?>" name="password" value="<?= $data['password']; ?>" />
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" class="form-control <?= (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>" name="confirm_password" value="<?= $data['confirm_password']; ?>" />
