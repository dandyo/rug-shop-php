<header class="header">
    <nav class="navbar navbar-expand-md">
        <div class="container-xl cntr">
            <a href="/index.html" class="navbar-brand"><img src="<?php echo MAINURLROOT; ?>images/logo.png" alt="Organic Looms"></a>
            ...
            <div class="navbar-wrap">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/press.html" title="Press">Press</a>
                        </li>
                        <li class="nav-item">
